...
from model.model_no_sns import Graph2seq
import pandas as pd
from dataset_dual import collate_fn, MyDataset
...
data = torch.load('../processed_data/dual_graph_rev_res.pt')
...
torch.save(all_graph_gen_beam,'MaKE_wo_sns_res.pt')
